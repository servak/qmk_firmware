...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|      |------+------+------+------+------+------|-----------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |Shift | Up  |Mode |
   * |------+------+------+------+------+------|      |------+------+------+------+------+------|-----|-----|
   * | Mode | Esc  |  Alt  | GUI |       Space |      |R_ALT | Esc | R_Alt | Left | Down |  Right |
   * `-----------------------------------------|      |-----------------------------------------'
   */
  [0] = LAYOUT( \
      ...
      MO(1),   KC_ESC,  KC_LALT, KC_LGUI, KC_SPC,             KC_RALT, KC_ESC,  KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT \
      ),
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |Shift | Up  |Mode |
   * |------+------+------+------+------+------|      |------+------+------+------+------+------|-----|-----|
   * |Adjust| Esc  |  Alt  | GUI |       Space |      |R_ALT | Esc | R_Alt | Left | Down |  Right |
   * `-----------------------------------------|      |-----------------------------------------'
   */
  [1] = LAYOUT( \
      KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,    KC_DEL, \
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,  \
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_SCLN, KC_QUOT, KC_ENT,   \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,   KC_UP,  MO(1),   \
      KC_ESC,  KC_ESC,  KC_LALT, KC_LGUI, KC_SPC,             KC_RALT, KC_ESC,  KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT \
  ),
